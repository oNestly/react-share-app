...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
	const newDestination = destination.toLowerCase().replace(/^http(s?):\/\//i, "")
						...
						<div className='flex justify-between items-center gap-2 w-full'>
							{newDestination && (
								...
								>
									...
									{newDestination.length > 20 ? (newDestination.slice(0, 20) + '...') : newDestination}
								</a>
							)}
